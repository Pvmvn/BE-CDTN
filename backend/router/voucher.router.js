...
import { applyVoucher, createVoucher, deactivateVoucher, deleteVoucher, findBestVoucher, getAvailableVouchers, getVouchers, toggleVoucherStatus, updateVoucher } from '../controllers/voucher/voucher.controller.js';
...
router.post('/best-voucher', verifyToken, findBestVoucher);
